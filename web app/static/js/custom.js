...
function focus_distance(e){
  e.preventDefault();
  display_msg(description_distance,
              "Distance minimale par rapport aux autres personnes",
              false);
};
...
function start(e){
  ...
  if (min_distance == "") {// DISTANCE NON RENSEIGNE
    display_msg(description_distance, "Veuillez renseigner votre distance minimale.", true);
      ...
      sendDataToFlask(true, "/connection", city_dist, []);
...
/**
 * GENERATION DE UUID
 * Code from https://stackoverflow.com/questions/105034/how-to-create-guid-uuid
 */
function uuidv4() {
